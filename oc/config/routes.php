 ...
 */
Route::set('post_new', 'dang-tin-rao-vat.html')
->defaults(array(
		'controller' => 'new',    
		'action'     => 'index',
));
 ...
 * search
 */
Route::set('search','tim-kiem.html')
->defaults(array(
        'controller' => 'ad',    
 ...
 * Captcha / contact
 */
Route::set('contact', 'lien-he.html')
->defaults(array(
		'controller' => 'contact',
		'action'	 => 'index',));
 ...
 * maintenance
 */
Route::set('maintenance', 'bao-tri.html')
->defaults(array(
